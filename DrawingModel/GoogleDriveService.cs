...
namespace GoogleDriveUploader.GoogleDrive
{
    public class GoogleDriveService
    {
        ...
        private void CreateNewService(string applicationName, string clientSecretFileName)
        {
            ...
            DriveService service = PrepareService(applicationName, credential);
        ...
        // PrepareService
        private static DriveService PrepareService(string applicationName, UserCredential credential)
        {
        ...
        private List<Google.Apis.Drive.v2.Data.File> ListFileAndFolderWithQueryString(string queryString)
        {
            ...
            Execute(returnList, listRequest);
            return returnList;
        }

        // Execute
        private static void Execute(List<Google.Apis.Drive.v2.Data.File> returnList, FilesResource.ListRequest listRequest)
        {
            do
            {
                try
        ...
        public Google.Apis.Drive.v2.Data.File UploadFile(string uploadFileName, string contentType, Action<IUploadProgress> uploadProgressEventHandler = null, Action<Google.Apis.Drive.v2.Data.File> responseReceivedEventHandler = null)
        {
            ...
            Google.Apis.Drive.v2.Data.File fileToInsert = PrepareFileToInsert(title);
            ...
            PrepareEventHandler(uploadProgressEventHandler, responseReceivedEventHandler, insertRequest);
            ExecuteUpload(uploadStream, insertRequest);
            return insertRequest.ResponseBody;
        }

        // PrepareFileToInsert
        private static Google.Apis.Drive.v2.Data.File PrepareFileToInsert(string title)
        {
        ...
        // ExecuteUpload
        private static void ExecuteUpload(FileStream uploadStream, FilesResource.InsertMediaUpload insertRequest)
        {
            try
            {
        ...
        // PrepareEventHandler
        private static void PrepareEventHandler(Action<IUploadProgress> uploadProgressEventHandler, Action<Google.Apis.Drive.v2.Data.File> responseReceivedEventHandler, FilesResource.InsertMediaUpload insertRequest)
        {
        ...
        //    try
        //    {
        //        Google.Apis.Drive.v2.Data.File file = GetFile(fileId);
        ...
        //// GetFile
        //private Google.Apis.Drive.v2.Data.File GetFile(string fileId)
        //{
        //    return _service.Files.Get(fileId).Execute();
        //}
    }
}
